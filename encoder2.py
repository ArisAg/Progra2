...
import enum
#import idx
from wpilib.interfaces.counterbase import CounterBase
...
def _freeEncoder(encoder: "Encoder"):
...
class Encoder(SendableBase):
    ...
    def setMaxPeriod(self, maxPeriod: float):
        ...
        :param axPeriod: The maximum time between rising and falling edges
    ...
    def setMinRate(self, minRate: float):
    ...
    def setDistancePerPulse(self, distancePerPulse: float) :
    ...
    def setSamplesToAverage(self, samplesToAverage: int) :
    ...
    def setPIDSourceType(self, pidSource: PIDSourceType):
